addLayer("m", {
    ...
    upgrades: {
        ...
        115: {
            title: "BB V",
            description: "Supreme Buyables 1,3,4 are stronger",
            cost: new Decimal(37.5e67), 
            unlocked() { return  ((hasUpgrade("m", 113)) && (hasUpgrade("m", 123)) && (hasUpgrade("m", 133))) },
        },
        125: {
            title: "MM 2x5",
            description: "xe1e14 Energy",
            cost: new Decimal(35e67), 
            unlocked() { return ((hasUpgrade("m", 113)) && (hasUpgrade("m", 123)) && (hasUpgrade("m", 133))) },
        },
        135: {
            title: "PU X",
            description: "^1.015 PF",
            cost: new Decimal(40e67), 
            unlocked() { return ((hasUpgrade("m", 113)) && (hasUpgrade("m", 123)) && (hasUpgrade("m", 133))) },
        },
    ...
    challenges: {
        11: {
            ...
            goal(){
                if (challengeCompletions("m", 11) == 0) return new Decimal("e29880001");
                if (challengeCompletions("m", 11) == 1) return new Decimal("e1.9302786560612e19"); // placeholder
            },
            unlocked() { 
        ...
        12: {
            ...
            canComplete: function() {return player.points.gte("e81643000001")},
