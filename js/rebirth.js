addLayer("rebirth", {
    ...
    gainMult() { // Prestige multiplier
        ...
        if (hasUpgrade('era', 493)) mult = mult.times("ee20")
        if (hasUpgrade('era', 1022)) mult = mult.times("e6e19")
    ...
    effect(){
        ...
        let omegacap = 0.25
        softcappedEffect = softcap(softcappedEffect, new Decimal("e1.5e22"), new Decimal(omegacap))
        ...
        effectDescription() {
            ...
            if (layerEffect.gte(new Decimal("e1.5e22")) ) {
