...
addLayer("i", {
    ...
    infoboxes: {
        ...
        challenge: {
            title: "Challenges",
            body() { return "Challenges nerfs progression by a few ways. Method 1: ^x of a particular currency. x is lower than 1. Method 2: Nerfing upgrade boost, or even removing it entirely. Method 3: [Most Time Consuming] Disabling passive generation and/or automation." },
...
addLayer("prestige", {
    ...
    upgrades: {
        ...
        43: {
            ...
            cost: new Decimal("1e137400"),
            unlocked() { return hasMilestone("sac", 13) && hasUpgrade("prestige", 42) },
        },
        44: {
            title: "That's not a big boost.",
            description: "Prestige Softcap is weaker, ^1.0025 PF",
            cost: new Decimal("1e143905"),
            unlocked() { return hasMilestone("sac", 13) && hasUpgrade("prestige", 43) },
        },
    },
    milestones: {
        1: {
...
addLayer("sac", {
    ...
    milestones: {
        ...
        14: {
            ...
            effectDescription: "^1.005 PF, x1,000 Energy, x1e10K PF",
        ...
        21: {
            ...
            effectDescription: "-^0.1 BP, BUT xe10 Energy",
            done() { return player["sac"].points.gte(21) }
        },
        22: {
            requirementDescription: "Sacrifice 22",
            effectDescription: "More Prestige Upgrades, Automate Mega Buyable 3. xe40K PF.",
    ...
    challenges: {
        11: {
            ...
            canComplete: function() {return player.points.gte("e389500")},
            goalDescription: "Get e389.5K PF.",
        ...
        12: {
            ...
            canComplete: function() {return player.points.gte("e1366000")},
            goalDescription: "Get e1,366,000 PF.",
            rewardDescription: "xe60K PF",
...
addLayer("e", {
    ...
    upgrades: {
            ...
            12: {
                title: "Still, another upgrade. Are these actually useless?",
    ...
    milestones: {
        ...
        8: {
            requirementDescription: "4e128 Energy: BIG TRADE-OFF",
            effectDescription: "Energy boost is ^0.4, BUT xe100K PF and x1T Energy",
            done() { return player["e"].points.gte(4e128) }
        },
    },
    branches: ["sac", "mega"],
    effect(){
