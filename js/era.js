addLayer("era", {
        ...
        "Main tab": {
            content: [
                ...
                ["display-text",
                    function(){
                        let a = ""
                        if (hasMilestone("era", 105)) {
                            a = a + "You have " + notationChooser(player.era.infec) + " Infinite Era Crystals. Each Infinite Era Crystal increases Era Crystal gain by 1,000, Era Fragment gain after nerf by 1.12, and SB5 hardcap by +0.001. Every new Infinite Era Crystal requires 2^1024 more Era Crystals than the previous."
                        } else {
                            a = a + "You have " + notationChooser(player.era.infec) + " Infinite Era Crystals. Each Infinite Era Crystal increases Era Crystal gain by 10. Every new Infinite Era Crystal requires 2^1024 more Era Crystals than the previous."
                        }
                        return a
                    }
                ],
        ...
        "Era Fragments and its upgrades": {
            content: [
                ...
                ["display-text",
                    function(){
                        let a = ""
                        a = a + "You have a total of " + notationChooser(player.era.eftotal) + " Era Fragments. (Unlike the other layers, EF Milestones require TOTAL EF and not CURRENT EF)"
                        return a
                    }
                ],
                "blank",
    ...
    milestones: {
        ...
        3: {
            requirementDescription: "Era Three: The journey truly begins.",
        ...
        105: {
            requirementDescription: "EF Milestone 5 - Req 777,777 EF on hand and e948 EC",
            effectDescription: "The boost of Infinite Era Crystals is alot stronger. You can find the boosts in the Main tab.",
            done() { return (player.era.ef.gte(777777) && player.era.ec.gte("e948")) },
            unlocked() { return hasMilestone("era", 104) },
        },
    },
    upgrades: {
        11: {
            ...
            description() {
                let a = "x2 Era Crystals"
                if (hasUpgrade("era", 14)) a = "x100 Era Crystals [STRENGTENED BY ErUp 1X+]"
                return a
            },
        ...
        153: {
            ...
            main() {
                ...
                if (hasUpgrade("m", 145)) eracompexp = 0.15
        ...
        12: {
            ...
            main() {
                ...
                if (hasUpgrade("era", 511)) euiec = new Decimal(2)
                if (hasUpgrade("era", 14)) euiec = new Decimal(2.1)
        ...
        313: {
            title: "Advanced ErUp 2.5",
            description: "its tight. MMP7 and all cell row 6 ups is stronger.",
            cost: new Decimal("1.3e1585"),
            currencyDisplayName: "Era Crystals",
            currencyInternalName: "ec",
            currencyLayer: "era",
            branches: ['321', '322', '323'],
        ...
        501: {
            ...
            currencyInternalName: "ec",
            currencyLayer: "era",
            branches: ['511', '512', '513', '514', '502', '503', '504', '505'],
        ...
        502: {
            ...
            currencyInternalName: "ec",
            currencyLayer: "era",
            branches: ['511', '512', '513', '514', '501', '503', '504', '505'],
        ...
        13: {
            title: "ErUp 1X: Lategame EC Boosts",
            description() {
                if (hasUpgrade("era", 14)) {
                    return "x3 EC gain per Era Buyable 8 and 9 bought. +50% EF gain before nerf. [POWERED BY ErUp 1X+]"
                } else {
                    return "x2 EC gain per Era Buyable 8 and 9 bought. +25% EF gain before nerf."
                }
            },
            ...
            effect() {
                let ttlebs = player.era.buyables[19].add(player.era.buyables[18]).add(player.era.buyables[22])
                let basee = 2
                if (hasUpgrade("era", 14)) basee = 3
                return new Decimal(basee).pow(ttlebs)
            },
            effectDisplay() {
        ...
        443: {
            ...
            cost: new Decimal("7e783"),
            currencyDisplayName: "Era Crystals",
            currencyInternalName: "ec",
            currencyLayer: "era",
            branches: ['435', '442', '454', '455'],
            unlocked() {return hasUpgrade("era", 502)},
        },
        306: {
            title: "You mean to say... That's POSSIBLE??",
            description: "x1.25 EF gain before nerf, ^1.025 Era Crystals",
            cost: new Decimal("2.5e796"),
            currencyDisplayName: "Era Crystals",
            currencyInternalName: "ec",
            currencyLayer: "era",
            unlocked() {return hasUpgrade("era", 502)},
        ...
        503: {
            title: "Advanced ErUp 41",
            description: "Well, you have all heard of the '+0.01 SB5 HC'...Now, it's time I reveal to you, x1.02 SB5 HC!!!",
            cost: new Decimal("2.5e843"),
            currencyDisplayName: "Era Crystals",
            currencyInternalName: "ec",
            currencyLayer: "era",
            branches: ['511', '512', '513', '514', '501', '502', '504', '505'],
            unlocked() {return hasUpgrade("era", 502)},
        },
        333: {
            title: "Advanced ErUp 5X",
            description: "Getting easier by the year - x1.05 EC per year and delay cell buyable softcap by x1.005.",
            cost: new Decimal("8.45e845"),
            currencyDisplayName: "Era Crystals",
            currencyInternalName: "ec",
            currencyLayer: "era",
            effectDisplay() {
                return "x" + notationChooser(new Decimal(1.05).pow(new Date().getFullYear()))+" EC, x" + notationChooser(new Decimal(1.005).pow(new Date().getFullYear()))+" Cell Softcap delay"
            },
            branches: ['322', '323', '341', '342', '343'],
            unlocked() {return hasUpgrade("era", 502)},
        },
        414: {
            title: "Trade-off [GLITCH]",
            description: "-0.01 Sac Scaling, wait theres no tradeoff??",
            cost: new Decimal("7e930"),
            currencyDisplayName: "Era Crystals",
            currencyInternalName: "ec",
            currencyLayer: "era",
            branches: ['404', '405', '421', '422', '423', '435'],
            unlocked() {return hasUpgrade("era", 502)},
        },
        504: {
            title: "Advanced ErUp 42",
            description: "Well, isn't it good when everything gives everything else? Yeah. For every era upgrade past 200, +0.0001 EP.",
            cost: new Decimal("1.1e1070"),
            currencyDisplayName: "Era Crystals",
            currencyInternalName: "ec",
            currencyLayer: "era",
            branches: ['511', '512', '513', '514', '501', '502', '504', '505'],
            unlocked() {return hasUpgrade("era", 503)},
        },
        511: {
            title: "Advanced ErUp 43",
            description: "EF Up. 9 and ErUp 1e1 is stronger.",
            cost: new Decimal("e1088"),
            currencyDisplayName: "Era Crystals",
            currencyInternalName: "ec",
            currencyLayer: "era",
            branches: ['511', '512', '513', '514', '521', '522', '523', '524', '525'],
            unlocked() {return hasUpgrade("era", 503)},
        },
        296: {
            title: "ErUp 65X",
            description: "Reduce scaling of EF from 2.9 to 2.85. Also, at 27 Era Buyable 9s, gain a xee18 MP boost and an x5e15 EC boost.",
            cost: new Decimal("8e1203"),
            currencyDisplayName: "Era Crystals",
            currencyInternalName: "ec",
            currencyLayer: "era",
            unlocked() {return hasUpgrade("era", 502)},
        ...
        383: {
            title: "Advanced ErUp 16X",
            description: "Mega Buyable 3's effect is exponentiated by slog(MP)^slog(MP).",
            cost: new Decimal("3.5e1240"),
            currencyDisplayName: "Era Crystals",
            currencyInternalName: "ec",
            currencyLayer: "era",
            branches: ['381', '382'],
        ...
        436: {
            title: "Advanced ErUp 29X",
            description: "Mega Buyable 5's effect is further improved (wait, x25 EC/buy is not enough?). EFUp 3,5,18 is stronger.",
            cost: new Decimal("3.22e1322"),
            currencyDisplayName: "Era Crystals",
            currencyInternalName: "ec",
            currencyLayer: "era",
            branches: ['441', '442', '443', '444', '445', '446'],
        ...
        512: {
            ...
            currencyInternalName: "ec",
            currencyLayer: "era",
            branches: ['521', '522', '523', '524', '525', '526'],
            unlocked() {return (hasUpgrade("era", 511))},
        },
        513: {
            title: "Advanced ErUp 21-3 [New naming scheme: Row-Column]",
            description: "Every 2 Era Buyable 2, gain 1 Era Buyable 5. Every 5 Era Buyable 9, gain 1 Era Buyable 6.",
            cost: new Decimal("4e1376"),
            currencyDisplayName: "Era Crystals",
            currencyInternalName: "ec",
            currencyLayer: "era",
            branches: ['521', '522', '523', '524', '525', '526'],
            unlocked() {return (hasUpgrade("era", 512))},
        },
        514: {
            title: "Advanced ErUp 21-4",
            description: "Supreme Buyable 1 is much stronger",
            cost: new Decimal("5e1450"),
            currencyDisplayName: "Era Crystals",
            currencyInternalName: "ec",
            currencyLayer: "era",
            branches: ['521', '522', '523', '524', '525', '526'],
        ...
        515: {
            title: "Advanced ErUp 21-5: Well, it's so close.",
            description: "Well, after buying this upgrade, it is just a matter of TIME before you get Era 4. Compounding III is stronger.",
            cost: new Decimal("1.63e1630"),
            currencyDisplayName: "Era Crystals",
            currencyInternalName: "ec",
            currencyLayer: "era",
            branches: ['521', '522', '523', '524', '525', '526'],
            unlocked() {return (hasUpgrade("era", 514))},
        },
        465: {
            title: "Advanced ErUp 36e: Now? Why now?",
            description: "Increase the effect of Mega Buyable 2 and the cost of Era Buyable 8 is is divided by 10.",
            cost: new Decimal("7.5e1757"),
            currencyDisplayName: "Era Crystals",
            currencyInternalName: "ec",
            currencyLayer: "era",
            branches: ['481', '482', '483'],
            unlocked() {return hasUpgrade("era", 474)},
        },
        ...
        1013: {
            ...
            main() {
                cf2exp = 1
                if (hasUpgrade("era", 436)) cf2exp = 1.7
        ...
        1021: {
            ...
            effect() {
                let lgx = new Decimal(5)
                if (hasUpgrade("era", 436)) lgx = new Decimal(3)
                return Decimal.max(player["era"].ef.add(1).log(lgx), 1)
            },
            effectDisplay() {
        ...
        1031: {
            ...
            main() {
                euiec = new Decimal(1.05)
                if (hasUpgrade("era", 511)) euiec = new Decimal(1.07)
                softcapDescriptionerup12 = ""
                sdsc = ""
                upgEffecterup12 = upgradeEffect(this.layer, this.id)
            },
        ...
        1062: {
            title: "EFUp 22: Your past sacrifices will not be forgotten",
            description: "Total Era Fragments boosts its gain (before nerf)",
            cost: new Decimal(155555),
            currencyDisplayName: "Era Fragments",
            currencyInternalName: "ef",
            currencyLayer: "era",
            unlocked() {return hasUpgrade("era", 1061)},
            effect() {
                return Decimal.max(player["era"].eftotal.add(1).pow(0.075), 1)
            },
            effectDisplay() {
                return notationChooser(upgradeEffect(this.layer, this.id))+"x EF" + softcapDescriptionef3
            },
            tooltip() {
                return "Formula: TEF^0.15"
            },
        },
        1063: {
            title: "EFUp 23: Irrational is the best-rational!",
            description: "Era Buyable 5's base would now be pi, Era Buyable 1's base would now be e^2, Mega Buyable 2's scaling is now reduced by pi/25.",
            cost: new Decimal(270000),
            currencyDisplayName: "Era Fragments",
            currencyInternalName: "ef",
            currencyLayer: "era",
            unlocked() {return hasUpgrade("era", 1062)},
        },
        1064: {
            title: "EFUp 24: Finality",
            description: "sudo awaken player_final_form1",
            cost: new Decimal(1000000),
            currencyDisplayName: "Era Fragments",
            currencyInternalName: "ef",
            currencyLayer: "era",
            unlocked() {return hasUpgrade("era", 1063)},
        },
        14: {
            title: "ErUp 1X+: Better prior boosts",
            description: "ErUp 1 multiplier x2 -> x100, ErUp 1e1 EC mult x2 -> x2.1 per upg, AdvErUp 1X: Boost x2 -> x3, Era Buyable 10 is also factored in, EF gain before nerf +25% -> +50%.",
            cost: new Decimal("4e1768"),
            currencyDisplayName: "Era Crystals",
            currencyInternalName: "ec",
            currencyLayer: "era",
            branches: ['11', '12', '13', '21', '22', '23', '24', '25'],
            unlocked() {return hasUpgrade("era", 13)},
        },
        1071: {
            title: "EFUp 25: Superiority",
            description: "Square Era Buyable 6 and 10 base.",
            cost: new Decimal(1.35e9),
            currencyDisplayName: "Era Fragments",
            currencyInternalName: "ef",
            currencyLayer: "era",
            unlocked() {return (hasUpgrade("era", 1064)&&hasUpgrade("bacteria", 43))},
        },
    },
    buyables: {
        11: {
            ...
            effect(x) {
                ...
                if (hasUpgrade("era", 1063)) base1 = new Decimal(Math.E).pow(2)
                base2 = x
        ...
        12: {
            ...
            effect(x) {
                ...
                if (hasUpgrade("w", 25)) base1 = base1.mul(new Decimal(player.w.upgrades.length / 100).add(1))
                base2 = x
        ...
        13: {
            ...
            display() {
                dis = "Cost: " + notationChooser(tmp[this.layer].buyables[this.id].cost) + " Era Crystals." 
                dis = dis + "<br>Bought: " + getBuyableAmount(this.layer, this.id) 
                if (this.extra().gte(1)) {
                    dis = dis + " + " + notationChooser(this.extra())
                }
                dis = dis + "<br>Effect: Boost Era Crystals gain by x" + notationChooser(buyableEffect(this.layer, this.id)) + " and Mastery Points by x" + notationChooser(buyableEffect(this.layer, this.id).pow(mpow))
                return dis
            },
            canAfford() {
                return player.era.ec.gte(this.cost())
            ...
            extra(){
                ...
                if (hasUpgrade("basic", 124)) extra = extra.plus(getBuyableAmount("mega", 15).div(4).floor())
                return extra
            },
            effect() {
        ...
        14: {
            ...
            display() {
                ...
                dis = dis + "<br>Effect: Boost Era Crystals gain by x" + notationChooser(buyableEffect(this.layer, this.id))
                return dis
            },
            canAfford() {
                return player.era.ec.gte(this.cost())
            ...
            effect() {
                ...
                if (hasUpgrade("basic", 125)) base1 = base1.pow(2.25)
                base2 = x
        ...
        15: {
            ...
            extra(){
                let extra = new Decimal(0)
                if (hasUpgrade("era", 513)) extra = extra.plus(getBuyableAmount(this.layer, 12).div(2).floor())
                return extra
            },
            display() {
                dis = "Cost: " + notationChooser(tmp[this.layer].buyables[this.id].cost) + " Era Crystals."
            ...
            effect() {
                let x = getBuyableAmount(this.layer, this.id).add(this.extra())
                base1 = new Decimal(3)
                if (hasUpgrade("era", 1063)) base1 = new Decimal(Math.PI)
                base2 = x
        ...
        16: {
            ...
            display() {
                let dis = "Cost: " + notationChooser(tmp[this.layer].buyables[this.id].cost) + " Era Crystals."
                dis = dis + "<br>Bought: " + getBuyableAmount(this.layer, this.id)
                if (this.extra().gte(1)) {
                    dis = dis + " + " + notationChooser(this.extra())
                }
                dis = dis + "<br>Effect: Boost Point Fragments gain by x" + notationChooser(buyableEffect(this.layer, this.id))
                return dis
            },
            canAfford() {
                return player.era.ec.gte(this.cost())
            ...
            extra(){
                let extra = new Decimal(0)
                if (hasUpgrade("era", 513)) extra = extra.plus(getBuyableAmount(this.layer, 19).div(5).floor())
                return extra
            },
            buy() {
                let cost = new Decimal(1)
            ...
            effect() {
                ...
                if (hasUpgrade("m", 152)) base1 = new Decimal("e2.78e18")
                if (hasMilestone("sac", 125)) base1 = new Decimal("e4.88e18")
                if (hasUpgrade("era", 1071)) base1 = base1.pow(2)
                base2 = x
                expo = new Decimal(1.026)
                eff = base1.pow(Decimal.pow(base2, expo))
                return eff
        ...
        18: {
            ...
            cost(x) {
                let base = 40
                if (hasUpgrade("era", 465)) base = 4
                if (x < 10) {
                    return new Decimal(base).mul(Decimal.pow(1.1, x))
                } else {
                    return new Decimal(base).mul(Decimal.pow(1.1, Decimal.pow(x, 0.75+x/40)))
                }
            },
            display() {
            ...
            buy() {
                let cost = new Decimal(1)
                if (!(hasUpgrade("era", 512))) player.era.ef = player.era.ef.sub(this.cost().mul(cost))
                setBuyableAmount(this.layer, this.id, getBuyableAmount(this.layer, this.id).add(1))
            },
            effect(x) {
                base1 = new Decimal(1.1)
                if (hasUpgrade("era", 1033)) base1 = new Decimal(1.15)
                if (hasUpgrade("era", 512)) base1 = new Decimal(1.18)
                base2 = x
                expo = new Decimal(1)
                eff = base1.pow(Decimal.pow(base2, expo))
                return eff
        ...
        19: {
            ...
            unlocked() { return (hasMilestone('era', 101)) },
            cost(x) {
                let costdec = new Decimal(1)
                if (hasUpgrade("bacteria", 41)) costdec = costdec.div(5)
                if (x < 5) {
                    return new Decimal(75).mul(Decimal.pow(1.15, x)).mul(costdec)
                } else {
                    if (x > 25) {
                        if (x > 25) {
                            return new Decimal(2e6).mul(Decimal.pow(1.21, Decimal.pow((x-26), 0.8+x/30))).mul(costdec)
                        } else {
                            return new Decimal(5e6).mul(Decimal.pow(1.21, Decimal.pow((x-26), 0.8+x/50))).mul(costdec)
                        }
                    } else {
                        return new Decimal(75).mul(Decimal.pow(1.19, Decimal.pow(x, 0.75+x/50))).mul(costdec)
                    }
                }
            },
            display() {
            ...
            tooltip() {
                return "Cost Formula: 75 x 1.15^Amt (below 5), 75 x 1.19^(Amt ^ 0.75+Amt/50) (after 4), 5M x 1.2^([Amt-26] ^ 0.75+Amt/x) [25-29 x=50, 30+ x=30, base = 2M instead of 5M]. Effect formula: " + notationChooser(base1) + "^(" + notationChooser(base2) + "^" + expo + ")."
            }
        },
        22: {
            title: "Era Buyable 10 (EF Buyable 3): Cellular Helper",
            unlocked() { return (hasUpgrade('c', 72)) },
            cost(x) {
                return new Decimal(5e6).mul(Decimal.pow(1.21, Decimal.pow(x, 1.2+x/30)))
            },
            display() {
                return "Cost: " + notationChooser(tmp[this.layer].buyables[this.id].cost) + " Era Fragments." + "<br>Bought: " + getBuyableAmount(this.layer, this.id) + "<br>Effect: Increase Cell Base Mult by x" + notationChooser(buyableEffect(this.layer, this.id))
            },
            canAfford() {
                return player.era.ef.gte(this.cost())
            },
            ...
            tooltip() {
                return "Cost Formula: 5M x 1.21^([Amt] ^ 1.2+Amt/30). Effect formula: " + notationChooser(base1) + "^(" + notationChooser(base2) + "^" + expo + ")."
            }
        },
        111: {
    ...
    exponent() {
        ...
        if (hasMilestone("sac", 124)) exponent = exponent.sub(0.060177)
        return exponent
    }, 
    ...
    update(diff) {
        ...
        if (hasMilestone("era", 1)) {
            ...
            if (hasUpgrade("era", 14)) gain = gain.times(50)
            ...
            if (hasUpgrade("m", 142)) gain = gain.times(5000)
            ...
            if (hasAchievement('sa', 35)) gain = gain.times(1.06)
            ...
            if(hasMilestone("sac", 123)) gain = gain.times(3134234)
            if(hasMilestone("sac", 129)) gain = gain.times(player.sac.points)
            ...
            if (hasUpgrade("era", 296)) gain = gain.times(5e15)
            ...
            if (hasMilestone("c", 8)) gain = gain.times(1e50)
            ...
            if (hasUpgrade("era", 13)) gain = gain.times(upgradeEffect('era', 13))
            if (hasMilestone("era", 104)) gain = gain.times(new Decimal(10).pow(player.era.milestones.length))

            // infinity
            let iecboost = new Decimal(10)
            if (hasMilestone("era", 105)) iecboost = new Decimal(1000)
            if (player.era.ec.gte(new Decimal(2).pow(1024))) gain = gain.times(new Decimal(iecboost).pow(player.era.infec))
            ...
            if (hasUpgrade("basic", 123)) gain = gain.pow(1.023)
            if (hasUpgrade("w", 94)) gain = gain.pow(1.04)
            if (hasUpgrade("era", 1042)) gain = gain.pow(1.02)
            if (hasUpgrade("era", 306)) gain = gain.pow(1.025)
            if (hasUpgrade("bacteria", 51)) gain = gain.pow(1.05)
            if (hasUpgrade("m", 155)) gain = gain.pow(1.02)
            ...
            if (hasUpgrade("era", 14)) player.era.baseef = player.era.baseef.times(1.2)
            ...
            if (hasUpgrade("bacteria", 11)) player.era.baseef = player.era.baseef.times(2)
            if (hasUpgrade("c", 35)) player.era.baseef = player.era.baseef.times(1.5)
            if (hasUpgrade("c", 73)) player.era.baseef = player.era.baseef.times(upgradeEffect("c", 73))
            ...
            if (hasUpgrade("era", 296)) player.era.nerfexponent = new Decimal(2.85)
            if (player.era.ef.lte(10)) {
                if (player.era.baseef.lte(2000)) {
                    player.era.nerf = 1
                } else {
                    if (player.era.baseef.lte(20000000)) {
                        player.era.nerf = player.era.baseef.pow(0.3)
                    } else {
                        player.era.nerf = player.era.baseef.pow(0.1)
                    }
                }
            } else {
                if (player.era.baseef.lte(100)) {
                    ...
                    if (player.era.baseef.lte(20000000)) {
                        ...
                        player.era.nerf = Decimal.max(player.era.nerfexponent.pow(player.era.ef.add(1).div(5).log(2)), 1)
                        if (player.era.nerf.lte(player.era.baseef.pow(0.525))) {
                            player.era.nerf = player.era.baseef.pow(0.525)
                        }
                    }
                }
            }
            ...
            if (hasAchievement("sa", 36)) player.era.multaftnerf = player.era.multaftnerf.times(1.02)
            ...
            if (hasAchievement("sa", 43)) player.era.multaftnerf = player.era.multaftnerf.times(1.02)
            if(hasMilestone("sac", 129)) player.era.multaftnerf = player.era.multaftnerf.times(1.1)
            if (hasMilestone("c", 8)) player.era.multaftnerf = player.era.multaftnerf.times(1.8)
            if (hasUpgrade("c", 73)) {
                if (player.era.ef.gte(1e8)) player.era.multaftnerf = player.era.multaftnerf.times(2)
                if (player.era.ef.gte(2.5e8)) player.era.multaftnerf = player.era.multaftnerf.times(2)
            }
            if (hasUpgrade("bacteria", 41)) player.era.multaftnerf = player.era.multaftnerf.times(3)
            if (hasUpgrade("bacteria", 31)) player.era.multaftnerf = player.era.multaftnerf.times(2)
            if (hasUpgrade("bacteria", 51)) player.era.multaftnerf = player.era.multaftnerf.times(2)
            if (hasUpgrade("bacteria", 44)) player.era.multaftnerf = player.era.multaftnerf.times(1.5)
            if (hasUpgrade("bacteria", 52)) player.era.multaftnerf = player.era.multaftnerf.times(1.6)
            ...
            if (hasUpgrade("era", 501)) {
                if (player.era.ef.div(gainef).gte(5)) {
                    ...
                    player.era.ef = player.era.ef.add(player.era.ef.mul(0.2))
                    player.era.eftotal = player.era.eftotal.add(player.era.ef.mul(0.2))
                }
            }
        ...
        if (hasUpgrade("bacteria", 32)) player.era.everythingpower = player.era.everythingpower.add(0.002)
        if (hasUpgrade("c", 35)) player.era.everythingpower = player.era.everythingpower.add(0.004)
        ...
        if (hasUpgrade("c", 64)) player.era.everythingpower = player.era.everythingpower.add(upgradeEffect("c", 64))
        if (hasUpgrade("era", 504)) player.era.everythingpower = player.era.everythingpower.add(new Decimal(player.era.upgrades.length - 200).mul(0.0001))
    },
