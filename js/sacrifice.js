addLayer("sac", {
    ...
    challenges: {
        11: {
            ...
            canComplete: function() {return player.points.gte("e516501") && (!(hasChallenge("m", 12))) && (!(inChallenge("m", 12)))},
            goalDescription: "Get e516.5K+1 PF.",
            rewardDescription: "x10B Energy and xe25K PF",
        },
        12: {
            name: "Sac Challenge 2",
            challengeDescription: "Basic Upgrades 8,10 gives no boost.",
            canComplete: function() {return player.points.gte("e1552501") && (!(hasChallenge("m", 12))) && (!(inChallenge("m", 12)))},
            goalDescription: "Get e1,552,501 PF.",
        ...
        13: {
            ...
            canComplete: function() {return player.points.gte("e191201") && (!(hasChallenge("m", 12))) && (!(inChallenge("m", 12)))},
            goalDescription: "Get e191,201 PF.",
        ...
        14: {
            ...
            canComplete: function() {return player.points.gte("e3153154") && (!(hasChallenge("m", 12))) && (!(inChallenge("m", 12)))}, 
            goalDescription: "Get e3,153,154 PF.", 
